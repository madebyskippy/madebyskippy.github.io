...
declare class InpDevWrapper {
    ...
    public virtualKeyPress(key: string): void;
    ...
    public update(): void;
    public toggleKeyboard(toggle: boolean): void;
    public toggleMouse(toggle: boolean): void;
}
declare class Tool extends RigidSprite implements Interactable {
    ...
    public texture: Texture;
    public playerOverlapping: boolean;
    public highlightSprite: Draw2DSprite;
...
declare class SFXData {
    public fname: string;
    public soundData: Sound;
    constructor(fname: string, game: GameObject);
}
declare class SFX {
    public jumpSFX: SFXData;
    public landSFX: SFXData;
    public knitUpSFX: SFXData;
    public knitDownSFX: SFXData;
    public collectYarnSFX: SFXData;
    public noKnitSFX: SFXData;
    public currentSFX: SFXData;
    public game: GameObject;
    constructor(game: GameObject);
    public setCurrentFX(sound: SFXData, shouldRepeat?: boolean): void;
}
declare class Player {
    ...
    public oppositeFacing(direction: Direction): Direction;
    public flipFacing(): void;
    public climb(): void;
    public updateTexture(): void;
    public lastTouchedPullableDirection(): Direction;
    public tryToPull(): void;
    public handleLanding(wasOnGround: boolean, isOnGround: boolean): void;
    public update(): void;
    public draw(draw2D: Draw2D, offset: number[]): void;
}
