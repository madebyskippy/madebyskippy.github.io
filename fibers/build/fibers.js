    ...
    */
    Rectangle.prototype.buildShape = function (size) {
        ...
        if (!this.isBuildable) {
            ...
            var offsetBottomTwo = bottom + offsetConstTwo;
            var horizCenter = (left + right) / 2;
            vertices = [
                [left, offsetBottom], [offsetLeft, offsetBottomTwo], [horizCenter, bottom], [offsetRight, offsetBottomTwo], [right, offsetBottom],
                [right, top], [left, top]];
        } else {
...
var Tool = (function (_super) {
    ...
    function Tool(options, game) {
        ...
        game.graphicsDevice.createTexture({
            ...
            onload: function (texture) {
                if (texture != null) {
                    _this.highlightSprite.setTexture(texture);
                    _this.highlightSprite.setTextureRectangle([0, 0, 128, 128]);
...
var SFX = (function () {
    ...
    SFX.prototype.setCurrentFX = function (sound, shouldRepeat) {
        if (typeof shouldRepeat === "undefined") { shouldRepeat = false; }
...
var Player = (function () {
    function Player(game, position) {
        ...
        this.checkCollision = function (arbiter, otherShape) {
            ...
            if (normal[1] > 0 && normal[1] >= Math.abs(normal[0])) {
                ...
                var wasOnGround = _this.onGround;
                _this.onGround = true;
                _this.handleLanding(wasOnGround, _this.onGround);
    ...
    Player.prototype.walkLeft = function () {
        ...
        var vel = this.rigidSprite.body.getVelocity();
        var walkingSpeed = this.isPulling ? this.PULL_SPEED : this.SPEED;
        var newVel = [-1 * walkingSpeed, vel[1]];
    ...
    Player.prototype.handleLanding = function (wasOnGround, isOnGround) {
    ...
    Player.prototype.update = function () {
        ...
        var isOnGround = this.stillOnGround();
