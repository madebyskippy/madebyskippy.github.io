...
var Rectangle = (function (_super) {
    ...
    */
    Rectangle.prototype.buildShape = function (size) {
        ...
        var vertices = this.game.physicsDevice.createRectangleVertices(left, top, right, bottom);
        var shape = this.game.physicsDevice.createPolygonShape({
            vertices: vertices,
            material: this.material,
            group: 4 /* OVERLAPPABLES */,
...
var Player = (function () {
    ...
    Player.prototype.flipFacing = function () {
        this.facing = (this.facing == 0 /* LEFT */) ? 1 /* RIGHT */ : 0 /* LEFT */;
    };
    ...
    Player.prototype.updateTexture = function () {
        if (this.isClimbing) {
            ...
            if (this.onGround) {
                var isStill = (Math.abs(this.rigidSprite.body.getVelocity()[0]) < this.THRESHOLD_STANDING_SPEED);
                if (isStill) {
                    this.setCurrentTexture(this.standTexture);
                } else {
                    if (this.isPulling) {
    ...
    Player.prototype.tryToPull = function () {
        if ((this.game.keyboard.keyPressed("LEFT") || this.game.keyboard.keyPressed("RIGHT")) && this.game.keyboard.keyPressed("E") && this.lastTouchedPullable && this.onGround && !this.isPulling) {
            var rectPos = this.lastTouchedPullable.body.getPosition();
            var playerPos = this.getPosition();

            var distToPullable = Math.abs(rectPos[0] - playerPos[0]);
            var threshold = this.playerDimensions[0] / 2 + 30;
            var isNotAbove = (rectPos[1] <= (playerPos[1] + this.playerDimensions[1] / 2 + 16));
...
var HUD = (function () {
    ...
    HUD.prototype.refreshSprites = function () {
    ...
    HUD.TEXTURE_FILE = "assets/yarnBall.png";
    return HUD;
})();
/**
* Created by martelly on 4/13/2014.
...
var currentState = new MenuState(game, "menuMain");
